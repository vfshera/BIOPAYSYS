...
namespace BiometricPayroll.FORMS
{
    public partial class AddUsers : Form
    {
        ...
        private void btnUserDetailCancel_Click(object sender, EventArgs e)
        {
            ClearFields();
        }
        ...
        private void btnSaveUser_Click(object sender, EventArgs e)
        {
            ...
            if (ValidateForm())
            {
                ...
                bool update = userdb.Register(txtName.Text.ToUpper(), txtEmail.Text.ToUpper(), roleDropDown.SelectedIndex.ToString(), passUtil.HashPassword(tbxPass.Text));

                if (update)
                {
                    Alert.Popup("User Saved!", Alert.AlertType.success);
            ...
            if (iError == (Int32)SGFPMError.ERROR_NONE)
            {
               if(img_qlty > 50)
                ...
                else
                {
                    ...
                    captured = false;
                    Alert.Popup("Enter FP Again!" , Alert.AlertType.error);
                }
            }
            else
            {
        ...
        public void addFP()
        {
            ...
            if (db.RegFP(addedUserID, "0", m_RegMin1))
            {
